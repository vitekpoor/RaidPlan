...
powershell -NoProfile -Command "[IO.File]::WriteAllText('%~dp0..\index.html', ((Get-Content -Raw -Encoding UTF8 '%~dp0venomous-abyss.html') -replace 'boss_2_marks\.png', 'raidplan/boss_2_marks.png'), (New-Object System.Text.UTF8Encoding $false))"
