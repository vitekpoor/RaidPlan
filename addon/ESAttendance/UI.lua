...
local function createMain()
  ...
  main.summary = main:CreateFontString(nil, "OVERLAY", "GameFontHighlight")
  main.summary:SetPoint("TOPLEFT", 14, -36)
  main.rosterInfo = main:CreateFontString(nil, "OVERLAY", "GameFontHighlightSmall")
  ...
  main.status = main:CreateFontString(nil, "OVERLAY", "GameFontHighlightSmall")
  ...
  main.lastRecord = main:CreateFontString(nil, "OVERLAY", "GameFontHighlightSmall")
...
local function createTextFrame()
  ...
  textFrame.title = textFrame:CreateFontString(nil, "OVERLAY", "GameFontNormalLarge")
  textFrame.title:SetPoint("TOPLEFT", 14, -12)
  textFrame.hint = textFrame:CreateFontString(nil, "OVERLAY", "GameFontHighlightSmall")
  ...
  textFrame.status = textFrame:CreateFontString(nil, "OVERLAY", "GameFontHighlightSmall")
