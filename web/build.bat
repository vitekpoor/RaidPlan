...
powershell -NoProfile -Command "[IO.File]::WriteAllText('%~dp0..\raid.html', ((Get-Content -Raw -Encoding UTF8 '%~dp0venomous-abyss.html') -replace '(boss_2_marks|sszorak_addon_0\d)\.png', 'web/$0'), (New-Object System.Text.UTF8Encoding $false))"
...
copy /Y hub.html ..\index.html >nul
...
if exist loot.html (
  powershell -NoProfile -Command "[IO.File]::WriteAllText('%~dp0..\loot.html', ((Get-Content -Raw -Encoding UTF8 '%~dp0loot.html') -replace '\"loot_items\.json\"', '\"web/loot_items.json\"'), (New-Object System.Text.UTF8Encoding $false))"
